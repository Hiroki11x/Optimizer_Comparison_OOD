...
def main():
    ...
    parser.add_argument('--irm_penalty_anneal_iters', type=float)
    ...
    # https://github.com/pytorch/pytorch/blob/9267fd8d7395074001ad7cf2a8f28082dbff6b0b/torch/optim/sgd.py#L54
    parser.add_argument('--momentum', type=float, default=0.9)
    parser.add_argument('--eps', type=float, default=1e-8) # for RMSProp and Adam

    # https://github.com/pytorch/pytorch/blob/9267fd8d7395074001ad7cf2a8f28082dbff6b0b/torch/optim/rmsprop.py#L55
    parser.add_argument('--alpha', type=float, default=0.99) # for RMSProp

    # https://github.com/pytorch/pytorch/blob/9267fd8d7395074001ad7cf2a8f28082dbff6b0b/torch/optim/adam.py#L46
    parser.add_argument('--beta_1', type=float, default=0.9) # for Adam
    parser.add_argument('--beta_2', type=float, default=0.99) # for Adam
    ...
    # Wandb Init
    if config.use_wandb:
        wandb_config = initialize_wandb(config)

        # For Wandb Sweep
        config = populate_config(config, wandb_config)
